...
§
MiMo v2.5 for Persian. Stickers: use @Stickers bot (API fails). Channel tone: honest/beginner, NOT marketing. Compare AgentSoul v1 to default, NOT v4.2. Start Cmd cleanup: rm -rf sessions/cache/logs before boot. /compress≠persistent memory. @Shg4lbot is separate Hermes on Railway.